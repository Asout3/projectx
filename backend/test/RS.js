  ...
  <html>
    <head>
      ...
      <style>
        ...
        body { font-family: 'Georgia', serif; font-size: 14px; line-height: 1.6; color: #222; margin: 0; padding: 0; text-align: justify; }
        h1, h2, h3 { margin-top: 40px; margin-bottom: 15px; }
        p { margin: 0 0 1em 0; }
        pre { background: #f5f5f5; padding: 15px; border-radius: 6px; border: 1px solid #ddd; overflow-x: auto; }
