...
function cleanUpAIText(text) {
  ...
  clean = clean.replace(/\\(\$)/g, '$'); // Fix escaped dollar signs
  return clean;
}
...
- **DO NOT** escape dollar signs or LaTeX backslashes.

MANDATORY CONTENT STRUCTURE:
1) Introduction
2) KEY SECTIONS: Create a ### subsection for EACH:
${subtopicList}
3) Practical Application/Exercise (include Math if relevant)
