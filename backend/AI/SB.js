...
console.log('CEREBRAS_API_KEY exists? meow meow meow:', !!process.env.CEREBRAS_API_KEY);
...
async function generateChapter(bookTopic, chapterNumber, chapterInfo, userId) {
  ...
  // 🔥 UPDATED: Optional diagrams with required captions
...
// // AI/MB.js – FIXED CODE WITH DIAGRAM CAPTIONS
