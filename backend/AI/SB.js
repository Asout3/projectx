...
// === Updated AI function with fetch and OpenRouter API ===
async function askAI(prompt, userId, bookTopic) {
  ...
  try {
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      method: "POST",
      headers: {
        "Authorization": "Bearer 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", // your API key here
        // Optional:
  ...
  <html>
    <head>
      ...
      <style>
        ...
        .toc h2 { font-size: 20px; border-bottom: none; margin-top: 0; }
        .toc ol { padding-left: 1em; }
      </style>
    </head>
    <body>
      ${marked.parse(formatMath(cleaned))}
      <div class="footer">Generated by Hailu AI Book Generator</div>
    </body>
  </html>`;
...
// Export your functions as needed, example:
export {
  askAI,
  generateChapter,
  generatePDF,
