...
async function generatePDF(content, outputPath) {  // Only 2 arguments
  return new Promise((resolve, reject) => {
    try {
      ...
      // -- Preprocess Markdown --
      marked.setOptions({ /* existing options */ });
      ...
      // -- Content Rendering --
      lines.forEach(line => {
        // [Keep all content rendering logic EXACTLY the same as before...]
        // Headers, tables, math blocks, etc. unchanged from your latest version
      });
      ...
      const addPageNumbers = () => {
        ...
        for (let i = 0; i < range.count; i++) {
          ...
          // Fixed Header
          doc.fontSize(10)
             .text("Generated by BookGen.AI", 50, 20, { align: 'left' });
