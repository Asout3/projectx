...
async function generatePDF(content, outputPath) {
  ...
  <html lang="en">
    ...
    <body>
      <!-- Header (shows on every page except cover) -->
      <div class="page-header">
        Generated by bookgen.ai
      </div>
      ...
      <!-- Main Content (your existing TOC and chapters will appear here) -->
    ...
    const instructions = {
      ...
      output: {
        ...
        pdf: {
          ...
          // Nutrient will automatically skip header/footer on cover due to negative margins
          header: {
            content: '<div style="font-size: 10px; text-align: center; width: 100%; color: #6b7280; padding-top: 10px;">Generated by bookgen.ai</div>',
            spacing: "5mm"
          },
          footer: {
            content: '<div style="font-size: 10px; text-align: center; width: 100%; color: #6b7280; padding-bottom: 10px;">Page {pageNumber}</div>',
            spacing: "5mm"
          },
          waitDelay: 3000,
          printBackground: true,
